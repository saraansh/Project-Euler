...
int main(){
  ...
  while(tests--){
    ...
    if(n < a){
      ...
      ll sum = 0, temp = 0;
      // Apply the logic in for loop directly wihout caring for the complexity O(N)
      // Because fibonacci series grows at an incredibly fast rate
      // Thus 4*10e16 would be reached in less than 80 iterations
      // To read more about the magic of fibonacci numbers, visit the link below:
